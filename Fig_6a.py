...
# Streudiagramm
ax.scatter(Z1, KDF1, color='blue', label='Experimental Data (47 Data Points)')
...
ax.set_title("Experimental Data – Cylindrical Shells under axial Compression (Lundquist, 1933)")
