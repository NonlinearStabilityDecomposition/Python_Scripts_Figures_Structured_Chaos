...
ax.axvspan(0, 400, facecolor='red', alpha=0.2, label='Regime 1')
ax.axvspan(400, 650, facecolor='yellow', alpha=0.2, label='Regime 2')
ax.axvspan(650, 20000, facecolor='green', alpha=0.2, label='Regime 3')




# Streudiagramm
ax.scatter(Z1, KDF1, color='blue', label='Experimental Data (133 Data Points)')
...
ax.set_title("Experimental Data – Conical Shells under axial Compression (Weingarten et al., 1965)")
...
#ax.set_xscale('log')
ax.axvline(400, linestyle=':', color='gray', alpha=0.75)
ax.axvline(650, linestyle=':', color='gray', alpha=0.75)
plt.tight_layout()
plt.show()
